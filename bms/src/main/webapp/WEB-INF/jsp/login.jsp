...
<div class="container">
  <div class="siteIcon"><img src="<%=basePath%>images/icon/icon.psd" alt="" data-toggle="tooltip" data-placement="top" title="欢迎使用博客管理系统" draggable="false" /></div>
  <form action="${pageContext.request.contextPath}/userlogin" method="post" autocomplete="off" class="form-signin">
