    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      ...
      <div class="row placeholders">
        <div class="col-xs-6 col-sm-3 placeholder">
          <h4>文章</h4>
          <span class="text-muted">${articleVo.aritcleCount} 条</span> </div>
        <div class="col-xs-6 col-sm-3 placeholder">
          <h4>心情</h4>
          <span class="text-muted">${articleVo.moodCount} 条</span> </div>
        <div class="col-xs-6 col-sm-3 placeholder">
          <h4>活跃用户</h4>
          <span class="text-muted">${articleVo.userCount} 条</span> </div>
        <div class="col-xs-6 col-sm-3 placeholder">
          <h4>访问量</h4>
          <span class="text-muted">${articleVo.readCount}</span> </div>
      </div>
      ...
      <div class="table-responsive">
        <table class="table table-striped table-hover">
          <tbody>
            <tr>
              <td>登录者: <span>${USER.username}</span>
            </tr>
            <tr>
              <td>上次登录时间: ${USER.lasttime} , 上次登录IP:${USER.ip}</td>
            </tr>
          </tbody>
        </table>
      </div>
