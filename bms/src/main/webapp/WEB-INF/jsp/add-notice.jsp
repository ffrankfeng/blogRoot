...
<!--summernote富文本编辑器-->
<link rel="stylesheet" type="text/css" href="<%=basePath%>lib/summernote/summernote.css">
<script src="<%=basePath%>lib/summernote/summernote.js"></script>
<script src="<%=basePath%>lib/summernote/lang/summernote-zh-CN.js"></script>
<script>
