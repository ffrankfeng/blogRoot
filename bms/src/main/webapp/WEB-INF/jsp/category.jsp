    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <div class="row">
        <div class="col-md-5">
          ...
          <form action="${pageContext.request.contextPath}/blog-manager/add-category" autocomplete="off">
            ...
            <div class="form-group">
              ...
              <input type="text" id="categoryKeywords" name="categoryKeywords" class="form-control" placeholder="在此处输入栏目关键字" autocomplete="off">
            ...
            <table class="table table-striped table-hover">
              <thead>
                <tr>
                  ...
                  <th><span class="glyphicon glyphicon-pushpin"></span> <span class="visible-lg">代码</span></th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>${category.categoryAnothername}</td>
                  <td>${category.categoryCount}</td>
                  <td>${category.categoryNum}</td>
                  <td><a href="update-category.html?categoryId=${category.categoryId}">修改</a> <a rel="${category.categoryId}">删除</a></td>
                </tr>
                </c:forEach>
              </tbody>
            </table>
	...
	$("#main table tbody tr td a").click(function(){
		...
		if (event.srcElement.outerText === "删除") 
		{
			if(window.confirm("此操作不可逆，是否确认？"))
			{
				$.ajax({
					type: "POST",
					url: "/blog-manager/delete-category",
					data: "id=" + id,
					cache: false, //不缓存此页面   
