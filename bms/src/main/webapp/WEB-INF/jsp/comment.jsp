...
<![endif]-->
  <script>
      function getCheckBox(){
          ...
          $.post(
              "${pageContext.request.contextPath}/blog-manager/delete-comment",
              {"ids":checked_counts},
              function(data){
          ...
          <table class="table table-striped table-hover">
            <thead>
              <tr>
                ...
                <th><span class="glyphicon glyphicon-file"></span> <span class="visible-lg">写评人</span></th>
                <th><span class="glyphicon glyphicon-file"></span> <span class="visible-lg">评论文章ID</span></th>
            ...
            <tbody>
              ...
              <tr>
                <td><input type="checkbox" class="input-control" name="checkbox[]" value="${comment.commentId}," /></td>
                <td class="article-title">${comment.commentContent}</td>
                <td>${comment.fromUsername}</td>
                <td>${comment.articleId}</td>
                <td>${comment.commentTime}</td>
                <td><a rel="1" name="see">查看</a></td>
              </tr>
              </c:forEach>
            </tbody>
          </table>
        ...
        <footer class="message_footer">
          <nav>
            ...
            <ul class="pagination pagenav">
              <fengf:page url="${pageContext.request.contextPath }/blog-manager/comment" />
            </ul>
          </nav>
        </footer>
    </div>
