...
<![endif]-->
  <script>
      function getCheckBox(){
          ...
          $.post(
              "${pageContext.request.contextPath}/blog-manager/delete-user",
              {"ids":checked_counts},
              function(data){
...
<section class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
        ...
        <ol class="breadcrumb">
          <li><a href="add-user.html">增加公告</a></li>
        </ol>
          ...
          <table class="table table-striped table-hover">
            <thead>
              <tr>
                ...
                <th><span class="glyphicon glyphicon-time"></span> <span class="visible-lg">email</span></th>
                <th><span class="glyphicon glyphicon-file"></span> <span class="visible-lg">phone</span></th>
                ...
                <th><span class="glyphicon glyphicon-time"></span> <span class="visible-lg">职业</span></th>
                <th><span class="glyphicon glyphicon-file"></span> <span class="visible-lg">加入日期</span></th>
                <th><span class="glyphicon glyphicon-time"></span> <span class="visible-lg">关注</span></th>
                <th><span class="glyphicon glyphicon-time"></span> <span class="visible-lg">粉丝</span></th>
                <th><span class="glyphicon glyphicon-time"></span> <span class="visible-lg">文章</span></th>
                <th><span class="glyphicon glyphicon-time"></span> <span class="visible-lg">心情</span></th>
            ...
            <tbody>
              <c:forEach items="${page.rows }" var="user">
                <tr>
                  <td><input type="checkbox" class="input-control" name="checkbox[]" value="${user.userId}," /></td>
          ...
          <nav>
            <div class="btn-toolbar operation" role="toolbar">
              ...
              <div class="btn-group" role="group">
                <button onclick="getCheckBox()" class="btn btn-default" data-toggle="tooltip" data-placement="bottom" title="删除全部选中" name="checkbox_delete">删除</button>
              </div>
            </div>
            <ul class="pagination pagenav">
              <fengf:page url="${pageContext.request.contextPath }/blog-manager/user" />
            </ul>
          </nav>
    </div>
  </div>
